(ns hara.io.base.writer-test
  (:use hara.test)
  (:require [hara.io.base.writer :refer :all]
            [hara.io.file :as fs]))

^{:refer hara.io.base.writer/-writer :added "3.0"}
...
^{:refer hara.io.base.writer/writer-types :added "3.0"}
