(ns hara.core.version-test
  (:use hara.test)
  (:require [hara.core.version :refer :all]))

^{:refer hara.core.version/parse-number :added "3.0"}
(fact "parse a number from string input"

  (parse-number "1") => 1)

^{:refer hara.core.version/parse-qualifier :added "3.0"}
...
^{:refer hara.core.version/parse :added "3.0"}
...
^{:refer hara.core.version/older? :added "3.0"}
