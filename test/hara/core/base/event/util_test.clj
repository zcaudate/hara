(ns hara.core.base.event.util-test
  (:use hara.test)
  (:require [hara.core.base.event.util :refer :all]))

^{:refer hara.core.base.event.util/handler-form :added "3.0"}
...
^{:refer hara.core.base.event.util/checker-form :added "3.0"}
...
^{:refer hara.core.base.event.util/is-special-form :added "3.0"}
...
^{:refer hara.core.base.event.util/parse-option-forms :added "3.0"}
(fact "create a label read the option forms"

  (parse-option-forms '((option :NIL [] nil)))
  => '{:NIL (clojure.core/fn [] nil)})

^{:refer hara.core.base.event.util/parse-default-form :added "3.0"}
(fact "create option for default behavior"

  (parse-default-form '((default 1000)))
  => [1000])

^{:refer hara.core.base.event.util/parse-on-handler-forms :added "3.0"}
...
^{:refer hara.core.base.event.util/parse-on-any-handler-forms :added "3.0"}
...
^{:refer hara.core.base.event.util/parse-try-forms :added "3.0"}
