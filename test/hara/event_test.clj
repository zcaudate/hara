...
^{:refer hara.event/clear-listeners :added "3.0"}
...
^{:refer hara.event/list-listeners :added "3.0"}
...
^{:refer hara.event/install-listener :added "3.0"}
...
^{:refer hara.event/uninstall-listener :added "3.0"}
(fact "uninstalls a global signal listener"

  (uninstall-listener 'hara.event-test/-hello-))

^{:refer hara.event/deflistener :added "3.0"}
...
^{:refer hara.event/signal :added "3.0"}
...
^{:refer hara.event/continue :added "3.0"}
...
^{:refer hara.event/default :added "3.0"}
...
^{:refer hara.event/choose :added "3.0"}
...
^{:refer hara.event/fail :added "3.0"}
(fact "used within a manage form to definitively fail the system"
...
^{:refer hara.event/escalate :added "3.0"}
...
^{:refer hara.event/raise :added "3.0"}
...
^{:refer hara.event/manage :added "3.0"}
...
^{:refer hara.event/with-temp-listener :added "3.0"}
